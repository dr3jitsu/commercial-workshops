...
- (Advanced) Make this data available to:  
  ...
  - **AWS Bedrock** (for AI-generated risk summaries).
...
4. **Phase 4 – OPTIONAL: Flink → Tableflow → DuckDB**
...
5. **Phase 5 – OPTIONAL: DuckDB \+ AWS Bedrock**  
     
   - Query Tableflow with DuckDB in Python.  
   - Call AWS Bedrock to generate risk summaries.
...
**Required for Phase 5 (optional):**

- AWS account with **Bedrock** access.  
- Local environment with:  
  - `python 3.9+`  
  - `duckdb`, `boto3`, `python-dotenv`
